...
[![Build Status](https://travis-ci.org/Hemant/Zipper.png)](https://travis-ci.org/Hemant/Zipper)
...
1. Add this package to the list of required packages, inside `composer.json`
  * for Laravel 5: `"hemant/zipper": "1.0.x"`
  * ~~for Laravel 4: `"hemant/zipper": "0.5.x"`~~
2. Run `composer update`

3. Go to `app/config/app.php`

  * add to providers `Hemant\Zipper\ZipperServiceProvider::class`
  * add to aliases `'Zipper' => Hemant\Zipper\Zipper::class`
...
## Another example
```php
$zipper = new \Hemant\Zipper\Zipper;
